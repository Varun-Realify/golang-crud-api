            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.TaskNotification"
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "default": 50,
                        "description": "Limit number of notifications (default: 50)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "models.TaskNotification": {
            ...
            "properties": {
                ...
                "platform": {
                    "$ref": "#/definitions/models.TaskPlatform"
                },
                "progress": {
                    "description": "Progress tracking (0-100)",
                    "type": "integer"
                },
                "status": {
                    "description": "Status and details",
                    "allOf": [
                        {
                ...
                "task_type": {
                    "description": "e.g. \"google:ads_ingest\", \"meta:campaign_create\"",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
